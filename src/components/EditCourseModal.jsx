...
const EditCourseModal = ({ courseId, onClose }) => {
  ...
  const handleAddModule = () => {
    setCurriculum([
      ...curriculum, 
      { id: 'm_' + Date.now(), title: '', status: 'active', type: 'video' }
    ]);
  };
  ...
  return (
    <div className="modal-overlay">
      <div className="modal modal-lg">
        <div className="modal-header" style={{ paddingBottom: '0', borderBottom: 'none', display: 'block' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', marginBottom: '16px' }}>
            <h3 style={{ margin: 0 }}>Kursu Düzenle</h3>
                  ...
                  curriculum.map((module, index) => (
                    <div key={module.id} style={{ display: 'flex', gap: '12px', alignItems: 'center', background: 'var(--bg-secondary)', padding: '12px', borderRadius: '12px', border: '1px solid var(--border)' }}>
                      ...
                      <input 
                        ...
                        style={{ flex: 1, border: '1px solid var(--border)', padding: '8px 12px', borderRadius: '8px', background: 'white' }}
                        placeholder="İçerik Başlığı (Örn: Newton Hareket Yasaları)"
                        required
                      />
                      <select 
                        value={module.type}
                        onChange={e => updateModule(module.id, 'type', e.target.value)}
                        style={{ width: '130px', border: '1px solid var(--border)', padding: '8px 12px', borderRadius: '8px', background: 'white' }}
                      >
                      ...
                      <select 
                        ...
                        style={{ width: '110px', border: '1px solid var(--border)', padding: '8px 12px', borderRadius: '8px', background: 'white' }}
                      >
                      ...
                      <button 
                        ...
                        style={{ background: 'none', border: 'none', color: 'var(--danger)', cursor: 'pointer', padding: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                      >
                        <Trash2 size={18} />
                      </button>
                    </div>
